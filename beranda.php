    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di SIA BUKU TAMU DINAS KOMINFO Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>ID Tamu</th><th width="30%">Tanggal</th><th>Nama</th><th>Jabatan</th><th>Alamat</th><th>No HP</th><th>Keperluan</th>
                            </tr>
                        </thead>
                        <tbody>
